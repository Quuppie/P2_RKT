...
delta_theta = deg2rad(1); % radians
delta_p_i = 1 * 6894.76; % pascals
delta_w_i = 0.0001; % m^3

gradient_scalar = [1/10000, 2000000, 1/10000];
...
for i = 1:1000
    ...
    for l = 1:Design_space_dimension
        ...
        delta_dist(i,l) = ((distance_test(i,l+1) - distance_test(i,1)) / delta_vals(l));
    end
    ...
    const.p_r_i = max([min([const.p_r_i + update_vector(2), 85 * 6894.76]), 0 ]);
